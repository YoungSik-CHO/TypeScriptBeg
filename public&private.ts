...
class User1 {
    name = 'kim'
    private familyName :string = 'kim'  // 성은 못바꾸니까 private 처리 해야 자식이 값을 못바꿈
...
class Square2 {
    ...
    draw(){
        let a = Math.random();
        let square2  = `<div style= "position:relative;
                      top:${a * 400}px;
                      left:${a * 400}px;
                      width:${this.width}px;
